...
-- property: a guarded LITERAL is still safe (guarded AND pure)
-- OBSERVED: planned, claiming `all`
--
...
test('GENERATED (unreviewed): a guarded LITERAL is still safe (guarded AND pure)', function ()
...
M.alpha = function (x)
  ...
  local w = enc(z, z and 'json' or nil)
  return w
end
...
M.beta = function (a)
  ...
  local d = enc(c, c and 'yaml' or nil)
  return d
end
...
return M
    ...
    eq("all", plan and plan.preserves, 'the behavioural claim')
