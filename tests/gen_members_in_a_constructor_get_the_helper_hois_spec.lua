...
-- property: members in a CONSTRUCTOR get the helper hoisted out (CART-0985)
...
test('GENERATED (unreviewed): members in a CONSTRUCTOR get the helper hoisted out (CART-0985)', function ()
