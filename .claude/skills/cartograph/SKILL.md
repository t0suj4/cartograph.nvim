...
32, in the order they may be trusted in. `graph_info` first — it reports which verbs
...
WRITE     txn_plan_moveset  txn_plan_optimize  txn_plan_declare
          ...
          txn_plan_replace  txn_plan_invert  txn_preview
          txn_save  txn_load
