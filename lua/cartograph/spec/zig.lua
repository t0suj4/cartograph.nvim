...
return {
    ...
    -- belong here.
    member_positions = {
        field_expression = 1, -- ★ o.NAME is child 1 with NO field, where c/cpp/rust
        -- spell the SAME node type with a `field` field. One node-type name, two
        -- relations -- the defect that kept ruby and haskell silently broken
        -- inside the old call list (CART-0499)
    },
