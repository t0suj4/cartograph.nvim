...
-- guard substrate now lives in spec/tsutil.lua (shared with the spec modules,
-- e.g. php's GUARDS, without a require cycle); aliased here for the engine's
-- generic guard machinery and lua's GUARDS.
