...
-- node_text (hot-path byte-slice) lives in the spec substrate so spec modules
-- share ONE definition without a require cycle ([[cartograph.spec.tsutil]]).
-- Aliased local → all call sites here are unchanged.
