...
M.EXPECTED = {
    ...
    cpp = { total = 114631, ['binder:declaration'] = 75190,
        ...
        ['missing:preproc_def'] = 287, ['binder:comma_expression'] = 211,
        ['extra:switch_statement'] = 208, ['extra:assignment_expression'] = 136,
        ['binder:for_statement'] = 126, ['extra:while_statement'] = 112,
        ['binder:preproc_ifdef'] = 67, ['binder:compound_statement'] = 52,
        ['missing:expression_statement'] = 27, ['extra:cond'] = 24,
        ['missing:preproc_function_def'] = 22, ['extra:call_expression'] = 14,
        ['binder:assignment_expression'] = 8, ['both:declaration_command'] = 5,
        ['both:expression_statement'] = 4, ['extra:comma_expression'] = 4,
        ['missing:command'] = 4, ['binder:declaration_command'] = 1, ['both:pipeline'] = 1,
        ['missing:if_statement'] = 1, ['missing:list'] = 1, ['missing:variable_assignment'] = 1 },
    cppmodern = { total = 45821, ['extra:expression_statement'] = 23095,
        ['binder:declaration'] = 14429, ['extra:if_statement'] = 4024,
        ['extra:declaration'] = 1927, ['binder:ERROR'] = 686, ['binder:if_statement'] = 666,
        ['extra:return_statement'] = 436, ['extra:for_statement'] = 176,
        ['extra:for_range_loop'] = 152, ['binder:expression_statement'] = 106,
        ['extra:switch_statement'] = 30, ['extra:while_statement'] = 21, ['extra:ERROR'] = 20,
        ['both:declaration'] = 16, ['extra:throw_statement'] = 13,
        ['extra:compound_statement'] = 11, ['missing:preproc_if'] = 3,
    ...
    go = { total = 35875, ['extra:expression_statement'] = 11245,
        ...
        ['binder:declaration'] = 151, ['extra:type_switch_statement'] = 104,
        ['extra:variable_declaration'] = 92, ['extra:call_expression'] = 84,
        ['missing:for_clause'] = 52, ['extra:for_clause'] = 42, ['extra:var_declaration'] = 42,
        ['extra:declaration'] = 31, ['extra:inc_statement'] = 31, ['extra:go_statement'] = 27,
        ['extra:communication_case'] = 23, ['extra:lexical_declaration'] = 23,
        ['missing:variable_declaration'] = 17, ['binder:expression_statement'] = 13,
        ['extra:select_statement'] = 11, ['extra:binary_expression'] = 9, ['extra:block'] = 9,
        ['missing:send_statement'] = 9, ['extra:dec_statement'] = 8,
        ['binder:variable_declaration'] = 6, ['both:for_clause'] = 6,
        ...
        ['both:variable_declaration'] = 3, ['both:lexical_declaration'] = 2,
        ['extra:sequence_expression'] = 2, ['missing:command'] = 2,
    ...
    haskell = { total = 5, ['binder:declaration'] = 3, ['binder:expression_statement'] = 1,
        ['extra:if_statement'] = 1 },
    jquery = { total = 1782, ['extra:expression_statement'] = 948, ['extra:if_statement'] = 309,
        ['extra:return_statement'] = 273, ['extra:variable_declaration'] = 61,
        ['missing:variable_declaration'] = 55, ['binder:expression_statement'] = 33,
        ['both:variable_declaration'] = 25, ['extra:for_statement'] = 15,
        ['extra:while_statement'] = 11, ['binder:if_statement'] = 10,
        ['binder:variable_declaration'] = 10, ['binder:while_statement'] = 10,
    ...
    python = { total = 341, ['extra:expression_statement'] = 231,
        ['extra:variable_declaration'] = 61, ['extra:if_statement'] = 18,
        ['missing:variable_declaration'] = 11, ['extra:return_statement'] = 8,
        ['binder:expression_statement'] = 5, ['missing:expression_statement'] = 3,
        ['binder:variable_declaration'] = 1, ['extra:for_in_statement'] = 1,
        ['extra:for_statement'] = 1, ['missing:subscript'] = 1 },
