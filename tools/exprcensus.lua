...
M.EXPECTED = {
    ...
    cpp = { total = 39752, ['extra:expression_statement'] = 21548, ['extra:if_statement'] = 10559,
        ['extra:declaration'] = 2751, ['extra:for_statement'] = 733,
        ['binder:if_statement'] = 519, ['binder:expression_statement'] = 467,
        ['missing:declaration'] = 436, ['extra:return_statement'] = 409,
        ['missing:preproc_if'] = 381, ['extra:preproc_ifdef'] = 327,
        ['missing:preproc_def'] = 287, ['extra:compound_statement'] = 270,
        ['binder:comma_expression'] = 211, ['extra:switch_statement'] = 208,
        ['extra:assignment_expression'] = 136, ['binder:for_statement'] = 126,
        ['binder:declaration'] = 124, ['extra:while_statement'] = 112,
        ['binder:preproc_ifdef'] = 59, ['extra:cond'] = 24,
        ['missing:preproc_function_def'] = 22, ['extra:call_expression'] = 14,
        ['binder:assignment_expression'] = 8, ['both:declaration_command'] = 5,
        ['extra:comma_expression'] = 4, ['missing:command'] = 4,
        ['missing:expression_statement'] = 2, ['binder:declaration_command'] = 1,
        ['both:declaration'] = 1, ['both:pipeline'] = 1, ['missing:if_statement'] = 1,
        ['missing:list'] = 1, ['missing:variable_assignment'] = 1 },
    cppmodern = { total = 30913, ['extra:expression_statement'] = 23121, ['extra:if_statement'] = 4025,
        ['extra:declaration'] = 1925, ['binder:if_statement'] = 669,
        ['extra:return_statement'] = 451, ['binder:declaration'] = 230,
        ['extra:for_statement'] = 177, ['extra:for_range_loop'] = 152,
        ['binder:expression_statement'] = 70, ['extra:switch_statement'] = 30,
        ['extra:while_statement'] = 22, ['extra:throw_statement'] = 13,
        ['missing:declaration'] = 8, ['both:declaration'] = 4,
        ['extra:compound_statement'] = 4, ['missing:preproc_if'] = 3,
        ['binder:return_statement'] = 2, ['extra:assignment_expression'] = 2,
        ['missing:for_range_loop'] = 2, ['binder:preproc_ifdef'] = 1, ['extra:cond'] = 1,
        ['extra:preproc_ifdef'] = 1 },
    ...
    libs = { total = 304, ['missing:declaration'] = 133, ['extra:declaration'] = 23,
        ...
        ['extra:if_expression'] = 2, ['extra:match_block'] = 2,
