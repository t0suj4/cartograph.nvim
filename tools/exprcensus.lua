...
M.EXPECTED = {
    bash = { total = 5735, ['missing:command'] = 1126, ['binder:declaration_command'] = 916,
        ...
        ['missing:list'] = 338, ['both:if_statement'] = 277,
        ...
        ['missing:for_statement'] = 16, ['binder:do_group'] = 11,
        ['binder:for_statement'] = 9, ['both:while_statement'] = 9, ['missing:string'] = 9,
        ['both:command'] = 7, ['binder:while_statement'] = 5, ['missing:pipeline'] = 5,
        ['binder:command'] = 3, ['binder:redirected_statement'] = 2,
        ['extra:for_statement'] = 2, ['extra:if_statement'] = 2,
        ['extra:while_statement'] = 2, ['missing:negated_command'] = 2,
        ['both:pipeline'] = 1, ['both:variable_assignment'] = 1,
        ['both:variable_assignments'] = 1, ['missing:command_substitution'] = 1,
        ['missing:while_statement'] = 1 },
    cpp = { total = 3156, ['binder:if_statement'] = 985, ['missing:declaration'] = 437,
        ['binder:expression_statement'] = 401, ['missing:preproc_if'] = 381,
        ['missing:preproc_def'] = 287, ['binder:comma_expression'] = 215,
        ['binder:for_statement'] = 138, ['binder:declaration'] = 114,
        ['binder:preproc_ifdef'] = 114, ['binder:compound_statement'] = 42,
        ['missing:preproc_function_def'] = 22, ['both:declaration_command'] = 5,
        ['binder:while_statement'] = 4, ['missing:command'] = 4,
    ...
    cppmodern = { total = 986, ['binder:if_statement'] = 812, ['binder:declaration'] = 108,
        ['binder:expression_statement'] = 41, ['missing:declaration'] = 11,
        ['binder:while_statement'] = 3, ['missing:preproc_if'] = 3,
        ['binder:preproc_ifdef'] = 2, ['binder:return_statement'] = 2,
        ['missing:for_range_loop'] = 2, ['binder:compound_statement'] = 1,
        ['both:declaration'] = 1 },
    go = { total = 2939, ['missing:assignment_statement'] = 2745, ['missing:for_clause'] = 58,
        ['extra:type_switch_statement'] = 45, ['extra:if_statement'] = 23,
        ['binder:if_statement'] = 16, ['binder:expression_statement'] = 11,
        ['binder:for_statement'] = 11, ['missing:send_statement'] = 9,
        ['binder:declaration_command'] = 3, ['both:declaration_command'] = 3,
        ['binder:while_statement'] = 2, ['extra:for_statement'] = 2, ['missing:command'] = 2,
        ['missing:declaration'] = 2, ['missing:if_statement'] = 2,
    ...
    libs = { total = 255, ['missing:declaration'] = 133, ['binder:class_declaration'] = 21,
        ...
        ['extra:match_expression'] = 2, ['missing:preproc_if'] = 2,
        ['binder:if_statement'] = 1, ['binder:preproc_ifdef'] = 1 },
    mootools = { total = 37, ['binder:expression_statement'] = 17, ['binder:if_statement'] = 13,
        ['extra:if_statement'] = 3, ['binder:for_statement'] = 2,
    ...
    rails = { total = 606, ['missing:assignment'] = 147, ['missing:call'] = 138, ['missing:string'] = 83,
        ['binder:if'] = 55, ['binder:if_modifier'] = 49, ['missing:binary'] = 40,
        ['missing:conditional'] = 28, ['binder:unless_modifier'] = 13,
        ['missing:if_modifier'] = 11, ['missing:operator_assignment'] = 11,
        ['binder:elsif'] = 5, ['binder:unless'] = 5, ['binder:operator_assignment'] = 3,
        ['missing:hash'] = 3, ['missing:if'] = 3, ['missing:return'] = 3,
        ['missing:heredoc_body'] = 2, ['missing:unless_modifier'] = 2, ['both:if'] = 1,
        ['both:if_modifier'] = 1, ['missing:unary'] = 1, ['missing:while_modifier'] = 1,
        ['missing:yield'] = 1 },
    -- recalib @ CART-0405: as ruby.
    ...
    ruby = { total = 403, ['missing:call'] = 130, ['missing:conditional'] = 61, ['missing:assignment'] = 56,
        ['missing:string'] = 52, ['binder:if'] = 26, ['missing:binary'] = 25,
        ['missing:if_modifier'] = 12, ['binder:if_modifier'] = 7, ['binder:while'] = 6,
        ['binder:elsif'] = 5, ['missing:unless_modifier'] = 5, ['binder:assignment'] = 4,
        ['missing:unary'] = 3, ['both:unless_modifier'] = 2, ['missing:array'] = 2,
        ['missing:operator_assignment'] = 2, ['binder:binary'] = 1, ['binder:case'] = 1,
