...
M.EXPECTED = {
    ...
    self = { ['binding-as-use'] = 77, ['df-over-collects'] = 490,
        ...
        -- +5 df-over @ extract-candidates (nested-block view). df-additive/inert —
        -- external corpora unchanged, no extraction/flow change.
